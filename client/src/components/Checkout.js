...
class _CheckoutForm extends React.Component {
  ...
  handleSubmitOrder = async () => {
    ...
    try {
      ...
      clearCart();
      this.showToast('You order has been successfully submitted!', true);
    } catch (err) {
      this.setState({ orderProcessing: false, modal: false });
    ...
    setTimeout(
      () =>
        this.setState(
          ...
          // if true is passed to the 'redirect' argument, redirect to home
...
const Checkout = () => (
  <StripeProvider apiKey='pk_test_AW5osxnvWBLXkSAM4GYNw0r0'>
    <Elements>
      <CheckoutForm />
    </Elements>
  </StripeProvider>
